...
Everyone reads S-00
        ...
        ├── Ondrej  S-02 engine          ← Marek tests against this stdout
        ├── Marek   S-03 tests (write now; merge after S-02)
        │           S-10 HTML (mock JSON until S-11/S-14)
        ├── Peťo    S-04 runbook + hook spec
        │           S-11 dispatcher (can emit fixture events before S-02 lands)
        └── Marian  S-05 skill/hook/plugin/MCP/show_lab
                    S-12 driver (fixture ASSIGN events + locations.json)
...
| [S-01](S-01-agents-md.md) | `AGENTS.md` | Jakub | A graded | ready | plan sign-off |
...
|---|---|---|---|
| Jakub | S-01 | quote sign-off on S-02 | spoken demo line |
| Ondrej | S-02 | help Peťo call `dispatch_job` | CLI in live demo |
| Marek | S-03 **and** S-10 | hook HTML to real events | unittest in live demo |
| Peťo | S-04 **and** S-11 | hook deny rehearsal | open the demo |
| Marian | S-05 **and** S-12 | S-14 if green | drive the laptop |
